...
def plot_ecg_diseases(csv_file: Path | str, output_file: str = 'ecg_diseases_chart.png') -> None:
    """
    ...
    # Get disease columns (exclude filename, age, sex)
    ...
    # Rotate x-axis labels if there are many diseases
...
def main() -> None:
    ...
    plot_ecg_diseases(csv_file, args.output)
